            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <p className="text-body-color mb-8 text-base">
                  We don’t just plan trips—we craft lifelong memories. Our handpicked destinations and exclusive local partnerships ensure you experience the world authentically, beyond the tourist traps.
                </p>
                <p className="text-body-color mb-12 text-base">
                  We prioritize eco-friendly stays, support local communities, and promote low-impact tourism to protect the places we love.
                </p>
              </div>
            </div>
